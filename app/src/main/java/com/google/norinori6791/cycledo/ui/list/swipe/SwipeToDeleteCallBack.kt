package com.google.norinori6791.cycledo.ui.list.swipe
...
abstract class SwipeToDeleteCallback(context: Context)
    ...
    private val archiveIcon = ContextCompat.getDrawable(context, R.drawable.ic_done_white_24dp)
    ...
    override fun onChildDraw(
        ...
        if (deleteIcon != null
            ...
            if (isLeftDirection) {
                ...
                val archiveIconRight =
                    itemView.left + (archiveIconMargin + archiveIconIntrinsicWidth)
